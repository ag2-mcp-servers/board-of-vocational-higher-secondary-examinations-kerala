...
class CertificateParameters(BaseModel):
    ...
    Regno: str = Field(..., description='Enter Regno', examples=['123456'])
    Year: str = Field(..., description='Enter Year', examples=['2020'])
    type: str = Field(..., description='Enter Exam Type', examples=['MARCH,SAY'])
...
class VochseCertificatePostRequest(BaseModel):
...
class VochseCertificatePostResponse(BaseModel):
...
class VochseCertificatePostResponse1(BaseModel):
...
class VochseCertificatePostResponse2(BaseModel):
...
class VochseCertificatePostResponse3(BaseModel):
...
class VochseCertificatePostResponse4(BaseModel):
...
class VochseCertificatePostResponse5(BaseModel):
...
class VochseCertificatePostResponse6(BaseModel):
